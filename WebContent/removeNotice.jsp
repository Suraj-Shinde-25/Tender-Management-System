	...
	<div class="container-fluid">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
			...
			<table style="border-radius: 10px">
				<tr>
					<td id="show" style="min-width: 920px; color: black; font-size: 20px; border:2px solid #26b0b0; background-color: white">Delete
						Notices</td>
				</tr>
			</table>
			...
			<table style="background-color: white">
				<tr
					style="color: white; font-size: 22px; font-weight: bold; background-color: #26b0b0">
				...
				<tr>
					<td style="border: 2px solid black; padding: 5px;"><%=noticeId%></td>
					<td style="border: 2px solid black; padding: 10px;"><%=noticeTitle%></td>
					<td cols="70" style="border: 2px solid black; padding: 10px;"><%=noticeDesc%></td>
					<td style="border: 2px solid black; padding: 5px;"><a href="RemoveNoticeSrv?noticeid=<%=noticeId%>"><button
