   ...
   <div class="col-md-8">
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
      ...
      --> 
     	...
     	<table style="border-radius:10px;  margin-left: 220px " >
			<tr >
				<td id="show" style="min-width:700px;min-height:0px;color:#22223b;">Edit Details And Click on Update</td>
			</tr>
		</table>
	...
	<form action="ChangePasswordSrv" method="post" style="padding: 40px">
		<table style="background-color:white">
			<th colspan="2" style="background-color: #26b0b0">Change Password<input type="hidden" name="vid" value="<%=vendor.getId() %>"></th>
			<tr><td style="color:#001524; padding: 20px 0px;'">	Enter Old Password: </td><td> <input type="password" name="oldpassword" required="required" style="height: 35px"></td></tr>					
			
			<tr><td style="color:#001524; padding: 20px 0px;">	Enter New Password: </td><td> <input type="password" name="newpassword" required="required" style="height: 35px"></td></tr>					
			
			<tr><td style="color:#001524; padding: 20px 1px;">	Re-Enter New Password: </td><td> <input type="password" name="verifynewpassword" required="required" style="height: 35px"></td></tr>					
			<tr><td colspan="2" align="center"><input type="submit" value="Change Password" class="btn btn-primary" style="font-size: 15px; padding: 9px 0px 9px;"></td></tr>
