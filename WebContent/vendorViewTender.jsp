...
<body>
	...
	<div class="container-fluid">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
     		 -->
			<table class="bg-info table table-bordered table-hover bg-white" style="background-color: #f7ede2; border: 2px solid #f7ede2">
				<tr
					style="color: white; font-size: 16px; font-weight: bold; background-color: #26b0b0">
					<td>Tender Name</td>
					<td>Type</td>
					<td>Budget</td>
					<td>Location</td>
