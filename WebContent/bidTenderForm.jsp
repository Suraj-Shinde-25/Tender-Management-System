   ...
   <div class="col-md-8">
	...
	<form action="BidTenderSrv" method="post">
		<table style="background-color:white">
			...
			<tr><td style="color:#001524">	Tendor Id : </td><td><input type="hidden" name="tid" value="<%= tender.getId()%>"><%= tender.getId()%></td></tr>
			<tr><td style="color:#001524">    Tendor Name: </td><td><%= tender.getName()%></td></tr>
			<tr><td style="color:#001524"> Tender Type:</td><td> <%= tender.getType()%></td></tr>
		   <tr><td style="color:#001524">	Deadline Reqd:</td><td><%= tender.getDeadline()%></td></tr>
	       <tr><td style="color:#001524"> Base Price :</td><td> <%= tender.getPrice()%></td></tr>
	       <tr><td style="color:#001524"> Location :</td><td> <%= tender.getLocation()%></td></tr>
		   <tr><td style="color:#001524"> Description: </td><td><textarea rows="2" cols="40" readonly><%=tender.getDesc() %> </textarea></td></tr>
		   <tr><td style="color:#001524">	Bid Amount : </td><td> <input type="number" name="bidamount" required="required" min="<%= tender.getPrice()%>" value="<%=tender.getPrice()%>"></td></tr>
		   <input type="hidden" name="biddeadline" required="required" value="<%= tender.getDeadline()%>">				
			<tr><td colspan="2" align="center" value="Launch"><input type="submit" value="Bid Now" class="btn btn-success" style="font-size: 15px"></td></tr>
