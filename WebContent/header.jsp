        ...
        <div class="container" >
            <div class="navbar-header my-1"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/hit1.png" alt="HIT Haldia" width="60px" height="60px" style="width: 60px; height: 60px; border-radius: 50%"/>
                </a>
                    <a class="navbar-brand" href="#"><h1 style="font-family: myFont;">Tender Management System</h1></a> <!-- Library Name fixed-->
