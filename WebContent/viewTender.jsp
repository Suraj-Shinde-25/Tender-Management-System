        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
			...
			<table style="background-color: white">
				<tr
					...
					<td style="padding: 5px 15px; border: 2px solid black">Tender Id</td>
					<td style="padding: 5px 15px; border: 2px solid black">Name</td>
					<td style="padding: 5px 15px; border: 2px solid black">Type</td>
					<td style="padding: 5px 15px; border: 2px solid black">Budget</td>
					<td style="padding: 5px 15px; border: 2px solid black">Location</td>
					<td style="padding: 5px 15px; border: 2px solid black">Deadline</td>
					<td style="padding: 5px 15px; border: 2px solid black">Description</td>
				</tr>
				<%
				...
				<tr>
					<td  style="border: 2px solid black"><a href="viewTenderBidsForm.jsp?tid=<%=tid%>"><%=tid%></a></td>
					<td  style="border: 2px solid black"><%=tname%></td>
					<td  style="border: 2px solid black"><%=ttype%></td>
					<td  style="border: 2px solid black">&#8377; <%=tprice%></td>
					<td  style="border: 2px solid black"><%=tloc%></td>
					<td  style="border: 2px solid black"><%=tdeadline%></td>
					<td  style="border: 2px solid black"><textarea rows="3" disabled><%=tdesc%></textarea></td>
				</tr>
