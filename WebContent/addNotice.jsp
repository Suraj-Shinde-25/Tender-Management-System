   ...
   <div class="col-md-8">
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
      ...
      --> 
     	...
     	<table style="border-radius:10px" >
			<tr >
				<td id="show" style="min-width:640px;min-height:0px;color:black; border: 2px solid #26b0b0">Enter Notice Details Below</td>
			</tr>
		</table>
	...
	<form action="AddNoticeSrv" method="post">
		<table style="background-color:white">
			<th colspan="2" style="background-color: #26b0b0; border: 2px solid black;">Add Notice</th>
			<tr><td style="color:red; border: 2px solid black;"> Notice Title  : </td>
			<td style="border: 2px solid black;"><input type="text" name="title" required="required" style="height: 35px"></td></tr>
		   <tr><td style="color:red; border: 2px solid black;">	Descripton   : </td>
		   <td style="border: 2px solid black;"> <textarea rows="4" cols="40" style="font-size:15px" name="info" required="required"></textarea></td></tr>
					
			<tr><td colspan="2" align="center" value="Launch" style="border: 2px solid black;">
			<input type="submit" class="btn btn-primary" style="height: 40px" value="Add Notice to Notice Board" name="user"></td></tr>
