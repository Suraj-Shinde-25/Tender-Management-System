   ...
   <div class="col-md-8">
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
     ...
     <table style="background-color:white">		
     		<tr style="color:black; font-size:22px; background-color:#26b0b0"> 
     		<td style="border: 2px solid black; padding: 5px">Tender Id</td> 
     		<td style="border: 2px solid black; padding: 5px">Tender Name </td> 
     		<td style="border: 2px solid black; padding: 5px"> Tender Type </td>
     		 <td style="border: 2px solid black; padding: 5px">Tender Price</td>
     		  <td style="border: 2px solid black; padding: 5px">Location</td>
     		   <td style="border: 2px solid black; padding: 5px">Deadline</td>
     		    <td style="border: 2px solid black; padding: 5px">Description</td> </tr>
     		<%
     		...
     		<tr> <td style="border: 2px solid black; padding: 5px"><%=tid %></td>
     		 <td style="border: 2px solid black; padding: 5px"><%=tname %></td> 
     		 <td style="border: 2px solid black; padding: 5px"><%=ttype %></td>
     		  <td style="border: 2px solid black; padding: 5px"><%=tprice %></td>
     		   <td style="border: 2px solid black; padding: 5px"><%=tloc %></td> 
     		   <td style="border: 2px solid black; padding: 5px"><%=tdeadline %></td>
     		    <td style="border: 2px solid black; padding: 5px"><%=tdesc %></td> </tr>
