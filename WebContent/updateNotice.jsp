   ...
   <div class="col-md-8">
    <!-- <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
     		 -->
     		 <div id="show" style="border-radius: 0px; border: 2px solid #26b0b0; background-color: white; font-size: 20px; margin-left: 19px">
     ...
     <table style="background-color:white">		
     		<tr style="color:white; font-size:18px; font-weight:bold;background-color:#26b0b0">
     		 <td style="border: 2px solid black; padding: 5px">Notice Id</td> 
     		 <td style="border: 2px solid black; padding: 5px">Title </td> 
     		 <td style="border: 2px solid black; padding: 5px"> Description</td> 
     		 <td style="border: 2px solid black; padding: 5px">Action </td></tr>
     		<%
     		...
     		<tr> <td style="border: 2px solid black;"><%= noticeId %> </td> 
     		<td style="width:120%;"><textarea name="title" readonly><%=noticeTitle %></textarea></td> 
     		<td style="border: 2px solid black;"><textarea name="info" cols="60" readonly><%=noticeDesc %></textarea></td>
     		<td style="border: 2px solid black;"><a href="updateNoticeForm.jsp?nid=<%=noticeId%>">
     		<button class="btn btn-success" style="padding: 7px 15px; margin: 5px">Update</button></a></td> </tr>
