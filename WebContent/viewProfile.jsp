...
<body>
   ...
   <div class="col-md-8">
	...
	%>
		...
		<table style="background-color:white; border: 2px solid #26b0b0;">
			<th colspan="2" style="background-color: #26b0b0">User Profile</th>
			<tr><td style="color:#001524">	Vendor Id  : </td><td><%= vendor.getId()%></td></tr>
			<tr><td style="color:#001524">    Vendor Name: </td><td><%= vendor.getName()%></td></tr>
		   <tr><td style="color:#001524">	Mobile No.    :</td><td> <%= vendor.getMobile()%></td></tr>
	       <tr><td style="color:#001524"> Email Id :</td><td> <%= vendor.getEmail()%></td></tr>
		   <tr><td style="color:#001524">	Address  : </td><td><textarea rows="2" cols="40" style="font-size:15px" name="vaddr" readonly><%=vendor.getAddress() %> </textarea></td></tr>
		   <tr><td style="color:#001524">	Company Name : </td><td> <%= vendor.getCompany()%></td></tr>
			<tr><td style="color:#001524" colspan="2" align="center" value="Launch"><a href="updateProfile.jsp" style="color:green">Click Here To Update Profile</a></td></tr>
